<x-layout>
    ...
    <form method="POST" action="/jobs/{{ $job->id }}">
                ...
                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    <div class="sm:col-span-4">
                        ...
                        <div class="mt-2">
                            ...
                            @error('title')
                                <p class="text-red-500 text-md mt-5 border border-red-500 w-fit px-4 py-2 rounded-md">
                                    {{ $message }}</p>
                            @enderror
                        </div>
                    </div>
        ...
        <div class="mt-6 flex justify-between items-center">
            <button form="delete-form" class="bg-red-500 !text-white px-4 py-2 rounded-md font-bold">Delete</button>
